...
gtag('config', 'G-HRJ1G6XTG1');`
  ...
  nitro: {
    ...
    prerender: {
      crawlLinks: false,
      routes: [
        '/', '/about', '/blog/do-analytics-engineers-need-to-know-dbt', '/most-wins', '/data-quality', '/attendances', '/all-time-table', '/five-game-streaks', '/big-win-streaks', '/longest-winless-gaps', '/most-chaotic-matches', '/one-nil-wins', '/ht-lead-no-win-streaks', '/comeback-kings', '/most-comebacks', '/manager-wins', '/manager-debuts', '/manager-timeline', '/scoring-trends', '/goal-minutes', '/scoring-runs',
        ...teamRoutes(),
        ...managerRoutes(),
        ...seasonRoutes(),
        ...pointsLostRoutes(),
