...
gtag('config', 'G-HRJ1G6XTG1', { 'send_page_view': false });`
  ...
  nitro: {
    ...
    prerender: {
      crawlLinks: false,
      routes: [
        '/', '/about', '/blog/do-analytics-engineers-need-to-know-dbt', '/most-wins', '/data-quality', '/attendances', '/all-time-table', '/five-game-streaks', '/big-win-streaks', '/longest-winless-gaps', '/most-chaotic-matches', '/fixture-red-cards', '/red-cards-by-season', '/one-nil-wins', '/ht-lead-no-win-streaks', '/comeback-kings', '/most-comebacks', '/manager-wins', '/manager-debuts', '/manager-timeline', '/scoring-trends', '/goal-minutes', '/scoring-runs', '/premier-league-current-unbeaten-runs', '/premier-league-golden-boot-winners', '/super-6-golden-goal-data', '/premier-league-table-if-man-city-games-voided', '/season-reviews/1992-93', '/season-reviews/1999-00', '/season-reviews/2016-17', '/season-reviews/2017-18', '/season-reviews/2018-19', '/season-reviews/2019-20', '/season-reviews/2020-21', '/season-reviews/2021-22', '/season-reviews/2022-23', '/season-reviews/2023-24', '/season-reviews/2024-25', '/season-reviews/2025-26', '/players/erling-haaland', '/players/mohamed-salah', '/players/son-heung-min', '/players/jamie-vardy', '/players/harry-kane', '/players/sergio-aguero',
        ...teamRoutes(),
        ...managerRoutes(),
        ...seasonRoutes(),
        ...pointsLostRoutes(),
