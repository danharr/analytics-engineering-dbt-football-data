...
copy (
    with players as (
        ...
        union all select 'Sergio Agüero', 'Sergio Agüero', 'Manchester City', '2016-17'
        union all select 'Sergio Agüero', 'Sergio Agüero', 'Manchester City', '2017-18'
        union all select 'Sergio Agüero', 'Sergio Agüero', 'Manchester City', '2018-19'
        union all select 'Sergio Agüero', 'Sergio Agüero', 'Manchester City', '2019-20'
        union all select 'Sergio Agüero', 'Sergio Agüero', 'Manchester City', '2020-21'
