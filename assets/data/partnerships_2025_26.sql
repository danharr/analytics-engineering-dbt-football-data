-- Top 5 assist-scorer partnerships for the 2025-26 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2025-26" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2025_26.csv' (header, delimiter ',')