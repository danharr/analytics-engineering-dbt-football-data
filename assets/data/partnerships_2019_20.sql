-- Top 5 assist-scorer partnerships for the 2019-20 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2019-20" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2019_20.csv' (header, delimiter ',')