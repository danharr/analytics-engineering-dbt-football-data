-- Top 5 assist-scorer partnerships for the 2022-23 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2022-23" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2022_23.csv' (header, delimiter ',')