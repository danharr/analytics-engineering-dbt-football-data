-- Top 5 assist-scorer partnerships for the 2021-22 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2021-22" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2021_22.csv' (header, delimiter ',')