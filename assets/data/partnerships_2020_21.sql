-- Top 5 assist-scorer partnerships for the 2020-21 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2020-21" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2020_21.csv' (header, delimiter ',')