-- Top 5 assist-scorer partnerships for the 2023-24 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2023-24" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2023_24.csv' (header, delimiter ',')