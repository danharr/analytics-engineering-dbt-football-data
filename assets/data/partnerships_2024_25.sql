-- Top 5 assist-scorer partnerships for the 2024-25 season. A partnership is an
...
-- seed via dim_player. Backs the "Season Reviews — 2024-25" page.
copy (
    with goals as (
        select
            player_id,
...
to 'assets/data/partnerships_2024_25.csv' (header, delimiter ',')