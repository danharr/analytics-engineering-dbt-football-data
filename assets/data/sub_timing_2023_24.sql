-- Substitution timing by team for the 2023-24 season: one row per substitution,
...
-- axis. Backs the /season-reviews/2023-24 page.
copy (
    select
        team_name,
        team_short_name,
...
to 'assets/data/sub_timing_2023_24.csv' (header, delimiter ',')