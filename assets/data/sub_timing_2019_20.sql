-- Substitution timing by team for the 2019-20 season: one row per substitution,
...
-- axis. Backs the /season-reviews/2019-20 page.
copy (
    select
        team_name,
        team_short_name,
...
to 'assets/data/sub_timing_2019_20.csv' (header, delimiter ',')