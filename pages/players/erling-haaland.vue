      ...
      <v-card color="secondary" variant="tonal">
        ...
        <v-card-text class="pt-0">
          <p class="mb-0">
            ...
            goal he has scored by each matchweek, from the 36 that broke the single-season
            record in 2022-23, through his 27-goal 2023-24 campaign and the 27 that won him
            the 2025-26 Golden Boot. The 2026-27 line is drawn dashed and starts from zero,
            growing as the current season progresses. Generated from the per-match event
