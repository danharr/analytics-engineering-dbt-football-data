  ...
  <v-row>
      ...
      <v-card color="secondary" variant="tonal">
        ...
        <v-card-text class="pt-0">
          <p class="mb-0">
            ...
            goal he has scored by each matchweek, from his 22-goal 2024-25 campaign through
    ...
    <v-col cols="12" md="10" offset-md="1">
      <v-card>
        ...
        <v-card-text>
          <PlayerGoalRaceChart :data="haalandGoals" />
        </v-card-text>
      </v-card>
    </v-col>
...
<script setup>
import { haalandGoals, datasetLd } from '~/composables/useData'
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Erling Haaland\'s cumulative Premier League goals by matchweek across 2024-25, 2025-26 and the in-progress 2026-27 season.'
    }
  ],
  script: [
    {
      ...
      innerHTML: JSON.stringify(datasetLd({
        ...
        description: 'Erling Haaland\'s cumulative Premier League goals by matchweek for the 2024-25, 2025-26 and in-progress 2026-27 seasons, from the per-match event feed.',
        path: '/players/erling-haaland',
        csv: 'haaland_goals.csv',
