...
const seasonRows = seasonTable.filter(r => r.season_label === '2017-18')
useHead({
  title: '2017-18 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2017-18 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
