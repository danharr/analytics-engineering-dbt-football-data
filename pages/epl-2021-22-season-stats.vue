...
const seasonRows = seasonTable.filter(r => r.season_label === '2021-22')
useHead({
  title: '2021-22 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2021-22 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
