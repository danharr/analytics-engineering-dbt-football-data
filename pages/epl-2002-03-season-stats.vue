...
const seasonRows = seasonTable.filter(r => r.season_label === '2002-03')
useHead({
  title: '2002-03 Season',
  meta: [{
    name: 'description',
    content: 'The final 2002-03 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
