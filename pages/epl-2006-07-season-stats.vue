...
const seasonRows = seasonTable.filter(r => r.season_label === '2006-07')
useHead({
  title: '2006-07 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2006-07 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
