    ...
    <v-col cols="12" md="10" offset-md="1">
      <v-card color="secondary" variant="tonal">
        <v-card-title>
          ...
          2025-26 Season Summary In Charts
        </v-card-title>
        <v-card-subtitle>
        ...
        <v-card-text class="pt-0">
          <p class="mb-0">
            The 2025-26 season in charts. Substitutions, yellow cards and red cards are
...
<script setup>
import { subTiming2025_26, topScorers2025_26, partnerships2025_26, yellowCards, redCards } from '~/composables/useSeasonReviewData'
...
useHead({
  title: '2025-26 Season Summary In Charts',
  meta: [
    {
      name: 'description',
      content: 'The 2025-26 Premier League season in charts: substitution, yellow card and red card timing heat maps plus the season\'s top five scorers and assist-scorer partnerships, generated from the per-match event feed.'
    }
  ],
  script: [
    {
      ...
      innerHTML: JSON.stringify(datasetLd({
        name: 'Premier League 2025-26 Season Summary Dataset',
        description: 'The 2025-26 Premier League season in charts: substitutions, yellow and red cards by minute, plus the top five scorers and assist-scorer partnerships, from the per-match event feed.',
