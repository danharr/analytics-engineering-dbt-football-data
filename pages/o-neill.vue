...
const thisManager = "Martin O'Neill"
...
useHead({
  title: "Martin O'Neill Premier League Record, Wins & Stats",
  meta: [{
    name: 'description',
    content: "Premier League record for Martin O'Neill: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
