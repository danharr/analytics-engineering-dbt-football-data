...
const seasonRows = seasonTable.filter(r => r.season_label === '2015-16')
useHead({
  title: '2015-16 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2015-16 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
