...
useHead({
  title: 'Roy Hodgson Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Roy Hodgson: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
