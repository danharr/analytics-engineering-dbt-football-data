...
useHead({
  title: 'Eddie Howe Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Eddie Howe: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
