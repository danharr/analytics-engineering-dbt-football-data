...
const seasonRows = seasonTable.filter(r => r.season_label === '2000-01')
useHead({
  title: '2000-01 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2000-01 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
