...
const seasonRows = seasonTable.filter(r => r.season_label === '2001-02')
useHead({
  title: '2001-02 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2001-02 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
