...
const seasonRows = seasonTable.filter(r => r.season_label === '2019-20')
useHead({
  title: '2019-20 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2019-20 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
