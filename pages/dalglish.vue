...
const thisManager = 'Kenny Dalglish'
...
useHead({
  title: 'Kenny Dalglish Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Kenny Dalglish: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
