...
const seasonRows = seasonTable.filter(r => r.season_label === '2009-10')
useHead({
  title: '2009-10 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2009-10 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
