...
const thisManager = 'Harry Redknapp'
...
useHead({
  title: 'Harry Redknapp Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Harry Redknapp: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
