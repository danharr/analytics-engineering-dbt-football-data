...
const seasonRows = seasonTable.filter(r => r.season_label === '1996-97')
useHead({
  title: '1996-97 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 1996-97 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
