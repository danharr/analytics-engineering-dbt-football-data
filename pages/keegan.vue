...
const thisManager = 'Kevin Keegan'
...
useHead({
  title: 'Kevin Keegan Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Kevin Keegan: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
