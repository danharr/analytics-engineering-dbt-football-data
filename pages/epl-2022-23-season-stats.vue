...
const seasonRows = seasonTable.filter(r => r.season_label === '2022-23')
useHead({
  title: '2022-23 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2022-23 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
