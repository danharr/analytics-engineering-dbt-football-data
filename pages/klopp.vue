...
const thisManager = 'Jürgen Klopp'
...
useHead({
  title: 'Jürgen Klopp Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Jürgen Klopp: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
