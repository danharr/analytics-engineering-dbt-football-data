...
useHead({
  title: 'Mark Hughes Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Mark Hughes: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
