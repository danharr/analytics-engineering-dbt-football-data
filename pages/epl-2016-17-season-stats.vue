...
const seasonRows = seasonTable.filter(r => r.season_label === '2016-17')
useHead({
  title: '2016-17 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2016-17 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
