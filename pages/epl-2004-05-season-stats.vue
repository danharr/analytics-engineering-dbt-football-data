...
const seasonRows = seasonTable.filter(r => r.season_label === '2004-05')
useHead({
  title: '2004-05 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2004-05 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
