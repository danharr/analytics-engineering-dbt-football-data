    ...
    <v-row>
      <v-col cols="12" md="10" offset-md="1">
        <v-card color="secondary" variant="tonal">
          ...
          <v-card-subtitle>Final Premier League table</v-card-subtitle>
        </v-card>
      </v-col>
      <v-col cols="12" md="10" offset-md="1">
...
const seasonRows = seasonTable.filter(r => r.season_label === '2023-24')
useHead({
  title: '2023-24 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2023-24 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
