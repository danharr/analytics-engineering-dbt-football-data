...
const seasonRows = seasonTable.filter(r => r.season_label === '1998-99')
useHead({
  title: '1998-99 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 1998-99 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
