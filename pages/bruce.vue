...
useHead({
  title: 'Steve Bruce Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Steve Bruce: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
