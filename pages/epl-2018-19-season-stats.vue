...
const seasonRows = seasonTable.filter(r => r.season_label === '2018-19')
useHead({
  title: '2018-19 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2018-19 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
