...
const seasonRows = seasonTable.filter(r => r.season_label === '2025-26')
useHead({
  title: '2025-26 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2025-26 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
