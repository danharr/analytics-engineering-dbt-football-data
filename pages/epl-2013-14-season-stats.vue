...
const seasonRows = seasonTable.filter(r => r.season_label === '2013-14')
useHead({
  title: '2013-14 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2013-14 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
