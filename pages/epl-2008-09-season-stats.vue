...
const seasonRows = seasonTable.filter(r => r.season_label === '2008-09')
useHead({
  title: '2008-09 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2008-09 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
