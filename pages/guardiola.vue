...
const thisManager = 'Pep Guardiola'
...
useHead({
  title: 'Pep Guardiola Premier League Record, Wins & Stats',
  meta: [{
    name: 'description',
    content: "Premier League record for Pep Guardiola: total wins, five biggest wins and losses, club-by-club record."
  }]
})
</script>
