...
const seasonRows = seasonTable.filter(r => r.season_label === '2011-12')
useHead({
  title: '2011-12 Premier League Final Table & Results',
  meta: [{
    name: 'description',
    content: 'The final 2011-12 Premier League table, with every club\'s record, points and goal difference.'
  }]
})
</script>
