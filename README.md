...
- **Team Season Pages** — a `/teams/<club>/2025-26` sub-page for each of the 20 Premier League clubs, showing every player's goals as a horizontal bar chart from the per-minute goal feed
