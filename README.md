...
- **Current Unbeaten Runs** — for every club in the current Premier League season, their last defeat and each win or draw since, drawn as a horizontal W/D strip with a marker where a new season starts
...
- **Table If Man City Lost Every Game** — the 2025-26 final table re-scored as if Manchester City lost every game 3-0, with each team's points and position change versus the real season
...
- **Season Reviews — 2016-17** — every substitution and every yellow/red card made by each club in the 2016-17 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2017-18** — every substitution and every yellow/red card made by each club in the 2017-18 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2018-19** — every substitution and every yellow/red card made by each club in the 2018-19 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2019-20** — every substitution and every yellow/red card made by each club in the 2019-20 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2020-21** — every substitution and every yellow/red card made by each club in the 2020-21 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2021-22** — every substitution and every yellow/red card made by each club in the 2021-22 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2022-23** — every substitution and every yellow/red card made by each club in the 2022-23 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
- **Season Reviews — 2023-24** — every substitution and every yellow/red card made by each club in the 2023-24 season, plotted as a 0-90 minute heat map per team, from the per-match event feed, plus the season's top 5 scorers and top 5 assist-scorer partnerships
...
- **Player Pages** — one page per selected player (**Erling Haaland** at `/players/erling-haaland`, **Harry Kane** at `/players/harry-kane`, **Mohamed Salah** at `/players/mohamed-salah`, **Son Heung-min** at `/players/son-heung-min`, **Jamie Vardy** at `/players/jamie-vardy` and **Sergio Agüero** at `/players/sergio-aguero`), charting cumulative Premier League goals by matchweek as one line per season
...
- **Super 6 Golden Goal Data** — the most common minute for the first goal in a match, as a per-minute histogram for each season from 2018-19 to 2025-26, from the per-match event feed
