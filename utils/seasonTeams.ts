...
// The 20 Premier League teams in the 2025-26 BBC match-events feed, with slugs
// matching the site's /teams pages where a page already exists.
export const SEASON_TEAMS: SeasonTeam[] = [
